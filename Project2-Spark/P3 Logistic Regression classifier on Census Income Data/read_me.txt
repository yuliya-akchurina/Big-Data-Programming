...
1 PySpark code file	- q3_income_prediction.py written in Python
...
test.sh				/spark-examples/project2/question3/test.sh
q3_income_prediction.py		/spark-examples/project2/question3/q3_income_prediction.py


To run the process:
1. Navigate to the directory: /spark-examples/project2/question3
